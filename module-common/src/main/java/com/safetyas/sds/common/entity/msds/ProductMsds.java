...
/*    @Column(name = "step01_01", columnDefinition = "varchar(255) comment '제품의 권고 용도'")
    ...
    @ManyToMany
    @JoinTable(name = "sds_product_matter_usage",
        joinColumns = @JoinColumn(name = "product_msds_seq"),
    ...
    @Column(name = "step02_03", columnDefinition = "LONGTEXT comment '유해,위험 문구'")
    private String step02_03;

    @Column(name = "step02_04", columnDefinition = "LONGTEXT comment '예방'")
    private String step02_04;

    @Column(name = "step02_05", columnDefinition = "LONGTEXT comment '대응'")
    private String step02_05;

    @Column(name = "step02_06", columnDefinition = "LONGTEXT comment '저장'")
    private String step02_06;

    @Column(name = "step02_07", columnDefinition = "LONGTEXT comment '폐기'")
    private String step02_07;

    @Column(name = "step02_08", columnDefinition = "varchar(100) comment '유해성,위험성 분류기준에 포함되지 않는 기타 유해성,위험성'")
    private String step02_08;


    @Column(name = "step04_0", columnDefinition = "LONGTEXT comment '눈에 들어갔을 때'")
    private String step04_01;

    @Column(name = "step04_02", columnDefinition = "LONGTEXT comment '피부에 접촉했을 때'")
    private String step04_02;

    @Column(name = "step04_03", columnDefinition = "LONGTEXT comment '흡입했을 때'")
    private String step04_03;

    @Column(name = "step04_04", columnDefinition = "LONGTEXT comment '먹었을 때'")
    private String step04_04;

    @Column(name = "step04_05", columnDefinition = "LONGTEXT comment '기타 의사의 주의사항'")
    private String step04_05;


    @Column(name = "step05_01", columnDefinition = "LONGTEXT comment '적절한 (및 부적절한) 소화제'")
    private String step05_01;

    @Column(name = "step05_02", columnDefinition = "LONGTEXT comment '화학물질로부터 생기는 특정 유해성'")
    private String step05_02;

    @Column(name = "step05_03", columnDefinition = "LONGTEXT comment '화재 진압 시 착용할 보호구 및 예방조치'")
    private String step05_03;


    @Column(name = "step06_01", columnDefinition = "LONGTEXT comment '인체를 보호하기 위해 필요한 조치사항 및 보호구'")
    private String step06_01;

    @Column(name = "step06_02", columnDefinition = "LONGTEXT comment '환경을 보호하기 위해 필요한 조치사항'")
    private String step06_02;

    @Column(name = "step06_03", columnDefinition = "LONGTEXT comment '정화 또는 제거 방법'")
    private String step06_03;


    @Column(name = "step07_01", columnDefinition = "LONGTEXT comment '안전취급요령'")
    private String step07_01;

    @Column(name = "step07_02", columnDefinition = "LONGTEXT comment '안전한 저장 방법'")
    private String step07_02;


    @Column(name = "step08_01", columnDefinition = "LONGTEXT comment '적절한 공학적 관리'")
    private String step08_01;

    @Column(name = "step08_02", columnDefinition = "LONGTEXT comment '호흡기 보호'")
    private String step08_02;

    @Column(name = "step08_03", columnDefinition = "varchar(100) comment '눈 보호'")
    private String step08_03;

    @Column(name = "step08_04", columnDefinition = "varchar(100) comment '손 보호'")
    private String step08_04;

    @Column(name = "step08_05", columnDefinition = "varchar(100) comment '신체 보호'")
    private String step08_05;


    @Column(name = "step10_01", columnDefinition = "LONGTEXT comment '화학적 안정성 및 유해 반응의 가능성'")
    private String step10_01;

    @Column(name = "step10_02", columnDefinition = "varchar(100) comment '피해야 할 조건'")
    private String step10_02;

    @Column(name = "step10_03", columnDefinition = "varchar(100) comment '피해야 할 물질'")
    private String step10_03;

    @Column(name = "step10_04", columnDefinition = "LONGTEXT comment '분해 시 생성되는 유해물질'")
    private String step10_04;


    @Column(name = "step11_01", columnDefinition = "LONGTEXT comment '가능성이 높은 노출 경로에 관한 정보'")
    private String step11_01;

    @Column(name = "step13_01", columnDefinition = "LONGTEXT comment '폐기방법'")
    private String step13_01;

    @Column(name = "step13_02", columnDefinition = "LONGTEXT comment '폐기 시 주의사항'")
